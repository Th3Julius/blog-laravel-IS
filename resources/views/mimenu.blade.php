<header class="bg-red-400">
    <div class="mx-auto max-w-5xl md:flex justify-between items-center p-3">
        <div class="text-center mb-2 md:md-0">
            <a href=""><p class="text-white text-xl mb-0">Mi Blog Personal</p></a>
        </div>
    ...
    <script src="https://kit.fontawesome.com/030c5e4c31.js" crossorigin="anonymous"></script>
</header>
